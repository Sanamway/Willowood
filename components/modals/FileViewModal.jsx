...
function FileViewModal({ onClose, upindex, isOpen, onOpen, userId, title, srcs, shortName, refreshData, deleteType }) {
  //File Upload Handler
  ...
  console.log("VIEW", router.query.type)
                      ...
                      <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-full ">
                        <thead className="text-xs text-gray-900 text-center bg-blue-50 rounded-md ">
                          <tr className="">
                            ...
                            {router.query.type !== "view" &&(<th className="px-2 py-1 lg:text-[0.8rem] text-[0.6rem] text-gray-600 font-bold">
                              Delete
                            </th>)}
                          </tr>
                        </thead>
                            ...
                            {srcs?.length > 0 ? (
                              srcs?.map((item) => (
                                <tr key={item?.id}>
                                 ...
                                 {router.query.type !== "view" && ( <td className="px-2 text-center whitespace-nowrap py-1 text-[0.6rem] text-gray-900 borde">
                                    <button
