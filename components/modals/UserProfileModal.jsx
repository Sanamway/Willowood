...
function UserProfileModal({ onClose, isOpen, onOpen, userId, mode, onDeletedData, method, endpoints }) {
  ...
  const methodDelete = async (userId, mode) => {
    console.log("USERPROFILE", userId)
    try {
      const resp = await axios[method](`${url}/api/${endpoints}?role_id=${userId}&mode=${mode}`, { headers });
