    ...
    <Layout>
      <div className="  w-full font-arial bg-white ">
        ...
        <div className="flex flex-row justify-between  h-max  px-5">
          <h2 className="font-arial font-normal text-3xl tabletitle py-2">{name?name :"Business Territory"}</h2>
        ...
        <div className="bg-white mb-6 select-none flex items-start justify-center max-w-full">
