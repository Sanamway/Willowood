...
const Employee = () => {
  const csvHeaders = [
    ...
    { label: "Application Fee Amt", key: "in_appl_amt" },
    { label: "Monthly Expense", key: "in_expence_amt" },
  ...
  const handlePageChange = (page, bg, bu, z, r, t, empCode) => {
    setCurrentPage(page);
    getAllEmployees(page?.selected + 1, bg, bu, z, r, t, empCode);
  };
              ...
              <tbody className="bg-white divide-y  divide-gray-200 text-xs">
                {data?.map((item, idx) => (
                  ...
                  <tr className="dark:border-2" key={idx}>
                    ...
                    <td className="px-4 py-2 dark:border-2 whitespace-nowrap">
                      {item.accept_the_policy ? "Accepted" : "Not Accepted"}
                    </td>
