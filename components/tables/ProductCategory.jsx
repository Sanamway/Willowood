            ...
            <table className="min-w-full divide-y border divide-gray-200">
              <thead className="border-b">
                <tr className="bg-gray-50 font-arial">
                  ...
                  <th className="px-6 w-[1%] py-0  text-left dark:border-2 text-xs font-medium text-gray-500  tracking-wider">
                    Category ID
                  </th>
                  <th className="px-6 w-[1%] py-2 text-left dark:border-2 text-xs font-medium text-gray-500  tracking-wider">
                    Image
                  </th>
