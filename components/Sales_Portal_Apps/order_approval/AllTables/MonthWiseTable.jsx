...
const MonthWiseTable = (props) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`flex text-black items-center justify-between rounded-t-md  p-2 font-bold text-center bg-yellow-300 `}
        >
        ...
        {!height && (
          ...
          >
            <table className="w-full text-sm text-left  h-full">
              <thead className="text-xs text-white-400 text-center bg-blue-800">
                <tr>
                  {props.heading === "Employee" && <th className="w-12 px-4 py-1 text-left text-[0.6rem] border font-bold ">
                    Employee Code
                  </th>}
                  <th className="w-12 px-4 py-1 text-left text-[0.6rem] border font-bold  text-white">
                    {props.heading}
                  </th>


                  <th className="w-12 px-4 py-1 text-center text-[0.6rem] border font-bold  text-white">
                    Demo
                  </th>

                  <th className="w-12 px-2 py-1 text-center text-[0.6rem] border font-bold text-white">
                    Area Cover
                  </th>
