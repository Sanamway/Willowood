      ...
      <Carousel
        ...
        >
          {bannerData.map((item, i) => (
            <div key={i} className="img flex items-center  w-full justify-center mt-1 rounded-lg  border-none cursor-pointer">
              <div className="image h-36 lg:h-72  w-full  rounded-lg">
                <img className="object-fit lg:object-fit aspect-square  w-full h-full rounded-lg" src={item.thumbnail} alt="image" />
              </div>
            </div>
          ))}
        </Carousel>
