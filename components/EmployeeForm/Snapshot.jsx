...
const Snapshot = (props) => {
  ...
  const highestQualificationArray = ["10th", "10+2", "Under Graduate", "Graduate", "Master Degree"];
  ...
  const validationSchema = Yup.object().shape({
    mobile: Yup.string().matches(/^(\+\d{1,3}[- ]?)?\d{10}$/, "Enter a valid Mobile")
  });
  ...
  const handleEditSnapshot = async () => {
    ...
    try {
      ...
      const respond = await axios
        .put(`${url}/api/update_snapshot/${router.query.id}`, JSON.stringify(modifiedData), {
          headers: headers,
          params :{roleId}
        })
        .then((res) => {
  ...
  const allGradeArray = [
    "A - Fresher + < 1 Yrs Exp. ( Up to 12 K )",
    "B-  1 to 3 Year ( 12 K to 15 K )",
    "C-  > 3 Year ( 15 K to 18 K )",
    "D - > Above 18 K"
  ];
      ...
      <div className="flex flex-col gap-2   lg:flex-row -mx-2 mb-2 ">
        <div className="w-full  px-2  lg:w-1/2 ">
          ...
          <select
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, prefix: e.target.value })}
          >
        ...
        <div className="w-full  lg:w-1/2 px-2">
          ...
          <input
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, midName: e.target.value })}
          />
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2   lg:flex-row -mx-2 mb-2 mt-2">
        <div className="w-full  px-2  lg:w-1/3 ">
          ...
          <input
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, age: e.target.value })}
          />
        </div>
        <div className="w-full  px-2  lg:w-1/3 ">
          <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="inputField">
          ...
          <select
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, grade: e.target.value })}
          >
            <option value="" className="focus:outline-none focus:border-b bg-white">
              -- Select --
            </option>
      ...
      <div className="flex flex-col gap-2   lg:flex-row -mx-2 mb-2 ">
        <div className="w-full  px-2  lg:w-1/2 ">
          ...
          <select
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, gender: e.target.value })}
          >
            <option value="" className="focus:outline-none focus:border-b bg-white">
              Option
            </option>
        ...
        <div className="w-full  px-2  lg:w-1/2 ">
          ...
          <select
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, bloodGroup: e.target.value })}
          >
            <option value="" className="focus:outline-none focus:border-b bg-white">
              Option
            </option>
        ...
        <div className="w-full  px-2  lg:w-1/2 ">
          ...
          <select
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, nationality: e.target.value })}
          >
            <option value="" className="focus:outline-none focus:border-b bg-white">
              Option
            </option>
      ...
      <div className="flex flex-col gap-2   lg:flex-row -mx-2 mb-2 ">
        <div className="w-full  px-2  lg:w-1/2 ">
          ...
          <input
            ...
            onChange={(e) => {
              e.target.value.length !== 11 && setSnapshotData({ ...snapshotData, mobile: e.target.value });
            }}
          />
        </div>
      </div>
      <div className="flex flex-col gap-2   lg:flex-row -mx-2 mb-8 ">
        <div className="w-full  px-2  lg:w-1/2 ">
          ...
          <select
            ...
            onChange={(e) => setSnapshotData({ ...snapshotData, skillType: e.target.value })}
          >
            <option value="" className="focus:outline-none focus:border-b bg-white">
              Option
            </option>
            {skillData.map((item) => (
              <option value={item.type_skill} className="focus:outline-none focus:border-b bg-white">
                {item.type_skill}
              </option>
            ))}
          </select>
