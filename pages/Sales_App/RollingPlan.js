...
const AdditionalInfo = (props) => {
    ...
    const getUserItem = () => {
        ...
        switch (role) {
            case 1: return <div className="flex w-full  w-28">
                ...
                <span className="w-28 ml-3">{JSON.parse(window.localStorage.getItem("userinfo"))?.business_segment
                }</span>
            </div>
            ...
            case 4: return <div className="flex w-full  w-28">
                ...
                <span className="w-28 ml-3">{JSON.parse(window.localStorage.getItem("userinfo"))?.business_unit_name}</span>
            </div>
            ...
            case 5: return <div className="flex w-full  w-28">
                ...
                <span className="w-28 ml-3">{JSON.parse(window.localStorage.getItem("userinfo"))?.zone_name}</span>
            </div>
            ...
            case 6: return <div className="flex w-full  w-28">
                ...
                <span className="w-28 ml-3">{JSON.parse(window.localStorage.getItem("userinfo"))?.region_name
                }</span>
            </div>

            case 9: return <div className="flex w-full  w-28">
                <div className="flex">
                    <p className=" font-bold text-sm text-blue-800 w-28">
                        Territory
                    </p>
                ...
                <span className="w-28 ml-3">{localStorageItems.tDes}</span>
            </div>
    ...
    const getSaleData = async (
        ...
        let paramsData
        // Default to empty string or null if necessary data is missing
        console.log("lop", territoryData)
        ...
        if (filterState.tId && filterState.tId !== "All") {
            ...
            (filterState.rId && !filterState.tId) || (filterState.rId && filterState.tId === "All")
        ) {
            paramsData = {
                year: yr || null,
                month:
        ...
        } else if ((filterState.zId && !filterState.rId) || (filterState.zId && filterState.rId === "All")) {
            paramsData = {
                year: yr || null,
                month:
                    month === "All" || !month ? null : moment(month).format("YYYY-MM-DD"),
        ...
        } else if ((filterState.buId && !filterState.zId) || (filterState.buId && filterState.zId === "All")) {
            paramsData = {
                year: yr || null,
                month:
                    month === "All" || !month ? null : moment(month).format("YYYY-MM-DD"),
        ...
        >
            ...
            <div className="flex flex-col gap-2 mb-4">
                ...
                <button
                    ...
                    className="p-2 bg-blue-500 text-white rounded-md w-36"
                >
            ...
            <div className="my-4">
                ...
                <div className="overflow-x-auto">
                    <h1 className="font-bold text-center bg-yellow-300" onClick={toggleCollapse}>Target VS Sales</h1>
                ...
                <table className="border-collapse border border-gray-200 text-[10px] font-bold">
                    <thead>
                        <tr className="bg-blue-800 text">
                            ...
                            <th className="border border-gray-200 px-2 py-2">Sale</th>
