...
const TotalOverDueAmtPop = ({ closeModal, regionData, catData, dueData }) => {
      ...
      <div className=" bg-gray-300/40 opacity-1 backdrop-blur-[4px] from-gray-50 to-transparent z-10 w-full flex items-center justify-center min-h-screen fixed top-0 right-0 left-0 bottom-0 ">
        <div className="mainContainer lg:w-[55%] w-full mx-2 h-auto   bg-white rounded-lg  ">
          <div className="flex items-center justify-between py-1.5 px-2 border-b-2">
            <div className="px-2 text-[0.89rem] font-semibold text-gray-500 py-1">Overdue Amount</div>
          ...
          <div className="wrapTitle flex items-center justify-end mt-4 px-6 gap-2 ">
            <button
              onClick={() => setSelected("category")}
              className={`text-[0.75rem] font-semibold pb-1.5  ${
                selected == "category"
                  ? " px-2  border-blue-400 bg-blue-400 text-white rounded-sm py-1.5"
                  : " px-2 text-gray-600 bg-gray-200 py-1.5 "
              }`}
            >
              View Invoice
            </button>
            <button
              ...
              className={`text-[0.75rem] font-semibold pb-1.5  ${
                selected == "region"
                  ? " border-blue-400 px-2 bg-blue-400 text-white rounded-sm py-1.5"
                  : " px-2 text-gray-600 bg-gray-200 py-1.5"
              }`}
            >
              Make Payment
...
export default TotalOverDueAmtPop;
