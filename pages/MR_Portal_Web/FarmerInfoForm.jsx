...
const FarmerInfo = () => {
  ...
  return (
    <Layout>
      ...
      <div className="relative overflow-auto w-full font-arial bg-white h-[100%]  ">
        ...
        <div className="bg-gray-0 p-4 bg-gray-100  w-full flex items-start absolute overflow-auto">
          <form
